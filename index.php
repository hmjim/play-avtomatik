...
// if(strpos( $ip , "178.176" ) === 0 || strpos( $ip , "31.173" ) === 0 || strpos( $ip , "213.141" ) === 0  || strpos( $ip , "188.162" ) === 0 || strpos( $ip , "188.170" ) === 0 || strpos( $ip , "176.59" ) === 0 || strpos( $ip , "188.170" ) === 0)
   // {	
    ...
    // }
// }
// if ( $_SERVER["HTTP_HOST"] != "play-avtomatikks.azurewebsites.net" ) {
...
curl_close( $ch );
$bodytag = str_replace( "((?!play-avtomatik\.me/b)\w+(?:\.\w+)+", "https://play-avtomatikks.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "play-avtomatikks.azurewebsites.net", $contents );
